...
O Script para criação do banco de dados se encontra na pasta \docs, arquivo "script database sql server.sql".
...
## Testes
Foi implementado um Teste Unitário, onde o projeto de testes se encontra na pasta \testes
